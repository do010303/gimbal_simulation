...
def generate_launch_description():
    ...
    # M2: legacy box_management node removed (role now split between box_manager
    # and box_hardware_adapter). See box_hardware_adapter/launch/box_full_stack.launch.py.
